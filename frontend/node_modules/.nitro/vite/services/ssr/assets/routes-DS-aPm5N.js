import { n as Card, r as StatusPill, t as AdminLayout } from "./admin-layout-CbX8iDgK.js";
import { t as api } from "./api-DRGUSpxz.js";
import { useEffect, useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { AlertTriangle, ArrowRight, Coins, CreditCard, Database, Flame, Gauge, Plus, Users, Wifi, WifiOff } from "lucide-react";
...
function Dashboard() {
	...
	return /* @__PURE__ */ jsxs(AdminLayout, {
		...
		children: [
			!loading && isSystemEmpty && /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(Database, { className: "h-6 w-6" })
					...
					children: [/* @__PURE__ */ jsxs(Link, {
						...
						children: [/* @__PURE__ */ jsx(Plus, { className: "h-4 w-4" }), " Add First Customer"]
					}), /* @__PURE__ */ jsxs(Link, {
						to: "/meters",
						...
						children: ["Add Meter ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
					})]
				})]
			}),
			/* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs(Card, {
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(ResponsiveContainer, { children: /* @__PURE__ */ jsxs(PieChart, { children: [
							/* @__PURE__ */ jsx(Pie, {
								...
								paddingAngle: 3,
								dataKey: "value",
								children: stats.meterStatusSeries.map((_, i) => /* @__PURE__ */ jsx(Cell, {
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: stats.meterStatusSeries.map((s, i) => /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				}), stats.recentActivity.length === 0 ? /* @__PURE__ */ jsx("div", {
