...
//#region src/components/modals/ManualRechargeModal.tsx
				...
				/* @__PURE__ */ jsxs("form", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
							...
							children: [meters.length === 0 && /* @__PURE__ */ jsx("option", {
								value: "",
								children: "No meters available"
							}), meters.map((m) => /* @__PURE__ */ jsxs("option", {
								value: m.id,
								children: [
									m.meterNumber,
									" (",
...
//#endregion
//#region src/routes/recharges.tsx?tsr-split=component
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(CreditCard, { className: "h-4 w-4" }), " Manual Recharge"]
				})]
			}),
			...
			/* @__PURE__ */ jsx(ManualRechargeModal, {
				isOpen: modalOpen,
