import { r as StatusPill, t as AdminLayout } from "./admin-layout-CbX8iDgK.js";
import { t as api } from "./api-DRGUSpxz.js";
import { t as DataTable } from "./data-table-BHmxasGg.js";
import { useEffect, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { Building, ChevronRight, FolderKanban, Layers, MapPin, Navigation, Plus, RefreshCw, Search, Trash2, X } from "lucide-react";
//#region src/routes/locations.tsx?tsr-split=component
function LocationsPage() {
	...
	const [districtDivId, setDistrictDivId] = useState("");
	const [districtName, setDistrictName] = useState("");
	const [areaDistId, setAreaDistId] = useState("");
	...
	return /* @__PURE__ */ jsxs(AdminLayout, {
		...
		children: [
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx(Navigation, { className: "h-5 w-5" })
						}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
							className: "text-2xl font-bold tracking-tight",
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: [
						...
						return /* @__PURE__ */ jsxs("button", {
							...
							children: [
								...
								t.count !== null && /* @__PURE__ */ jsx("span", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Search, { className: "h-3.5 w-3.5 absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" }), /* @__PURE__ */ jsx("input", {
								type: "text",
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("button", {
									...
									children: [/* @__PURE__ */ jsx(Plus, { className: "h-3.5 w-3.5" }), " Division"]
								}),
								/* @__PURE__ */ jsxs("button", {
									onClick: () => {
										setActionError(null);
									...
									children: [/* @__PURE__ */ jsx(Plus, { className: "h-3.5 w-3.5" }), " District"]
								}),
								/* @__PURE__ */ jsxs("button", {
									onClick: () => {
										setActionError(null);
									...
									children: [/* @__PURE__ */ jsx(Plus, { className: "h-3.5 w-3.5" }), " Area"]
								}),
								/* @__PURE__ */ jsxs("button", {
									onClick: () => {
										setActionError(null);
									...
									children: [/* @__PURE__ */ jsx(Plus, { className: "h-3.5 w-3.5" }), " Project"]
								})
							]
						})
					]
			...
			activeTab === "all" && /* @__PURE__ */ jsx("div", {
				className: "space-y-6",
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("h3", {
								...
								children: [/* @__PURE__ */ jsx(Layers, { className: "h-4 w-4 text-primary" }), "Geographic Zoning Structure"]
							}),
							/* @__PURE__ */ jsx("p", {
							...
							/* @__PURE__ */ jsxs("div", {
									...
									return /* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsx(Building, { className: "h-3.5 w-3.5 text-blue-500" }), /* @__PURE__ */ jsxs("span", { children: [div.name, " Division"] })]
											}), /* @__PURE__ */ jsxs("span", {
										...
										}), divDistricts.length > 0 && /* @__PURE__ */ jsx("div", {
											...
											children: divDistricts.map((dist) => {
												...
												return /* @__PURE__ */ jsxs("div", {
													...
													children: [/* @__PURE__ */ jsxs("div", {
														...
														children: [/* @__PURE__ */ jsxs("div", {
															className: "flex items-center gap-1.5",
															children: [/* @__PURE__ */ jsx(ChevronRight, { className: "h-3 w-3 text-muted-foreground" }), /* @__PURE__ */ jsx("span", { children: dist.name })]
														}), /* @__PURE__ */ jsxs("span", {
															className: "text-[10px] text-muted-foreground",
															children: [distAreas.length, " areas"]
														})]
													}), distAreas.length > 0 && /* @__PURE__ */ jsx("div", {
														className: "flex flex-wrap gap-1.5 mt-1.5 pl-4",
														children: distAreas.map((area) => /* @__PURE__ */ jsxs("span", {
															...
															children: [
																/* @__PURE__ */ jsx(MapPin, { className: "h-2.5 w-2.5 text-emerald-500" }),
																area.name,
																area.postalCode && /* @__PURE__ */ jsxs("span", {
																	className: "text-[10px] text-muted-foreground",
																	children: [
																		"(",
																		area.postalCode,
								...
								}), data.divisions.length === 0 && !loading && /* @__PURE__ */ jsx("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("h3", {
									...
									children: [/* @__PURE__ */ jsx(FolderKanban, { className: "h-4 w-4 text-amber-500" }), "Smart Gas Projects"]
								}), /* @__PURE__ */ jsxs("button", {
									onClick: () => {
										setActionError(null);
										setAddProjectOpen(true);
									...
									children: [/* @__PURE__ */ jsx(Plus, { className: "h-3 w-3" }), " New Project"]
								})]
							}),
							/* @__PURE__ */ jsx("p", {
							...
							/* @__PURE__ */ jsxs("div", {
								className: "space-y-3",
								children: [data.projects.map((proj) => /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", { children: [
										...
										/* @__PURE__ */ jsx("div", {
											...
											children: proj.areaName && /* @__PURE__ */ jsxs("span", {
												className: "flex items-center gap-1",
												children: [
													/* @__PURE__ */ jsx(MapPin, { className: "h-3 w-3 text-emerald-500" }),
													"Area: ",
													proj.areaName
												]
											})
								...
								}, proj.id)), data.projects.length === 0 && !loading && /* @__PURE__ */ jsx("div", {
									className: "text-center py-6 text-xs text-muted-foreground",
			...
			activeTab === "divisions" && /* @__PURE__ */ jsx(DataTable, {
				loading,
				...
				columns: [
					...
					},
					{
						...
						render: (r) => /* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ jsx(Building, { className: "h-4 w-4 text-blue-500" }), /* @__PURE__ */ jsx("span", {
								className: "font-semibold text-xs text-foreground",
								children: r.name
							})]
						})
			...
			activeTab === "districts" && /* @__PURE__ */ jsx(DataTable, {
				loading,
				...
				columns: [
					...
					},
					{
						...
						render: (r) => /* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ jsx(Navigation, { className: "h-4 w-4 text-indigo-500" }), /* @__PURE__ */ jsx("span", {
								className: "font-semibold text-xs text-foreground",
								children: r.name
							})]
						})
			...
			activeTab === "areas" && /* @__PURE__ */ jsx(DataTable, {
				loading,
				rows: filteredAreas,
				...
				columns: [
					...
					},
					{
						...
						render: (r) => /* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ jsx(MapPin, { className: "h-4 w-4 text-emerald-500" }), /* @__PURE__ */ jsx("span", {
								className: "font-semibold text-xs text-foreground",
								children: r.name
							})]
						})
			...
			activeTab === "projects" && /* @__PURE__ */ jsx(DataTable, {
				loading,
				...
				columns: [
					{
						key: "name",
						header: "Project Name",
						render: (r) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ jsx(FolderKanban, { className: "h-4 w-4 text-amber-500" }), /* @__PURE__ */ jsx("span", {
								className: "font-semibold text-xs text-foreground",
								children: r.name
							})]
						}), r.description && /* @__PURE__ */ jsx("div", {
					...
					},
					{
						key: "status",
						header: "Status",
						render: (r) => /* @__PURE__ */ jsx(StatusPill, {
							tone: "success",
							children: r.status
						})
					},
			...
			addDivisionOpen && /* @__PURE__ */ jsx("div", {
			...
			addDistrictOpen && /* @__PURE__ */ jsx("div", {
				className: "fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm p-4 animate-in fade-in",
				children: /* @__PURE__ */ jsxs("div", {
					className: "w-full max-w-md rounded-2xl bg-card border border-border p-6 shadow-2xl relative",
					children: [
						...
						/* @__PURE__ */ jsxs("form", {
							...
							children: [
								/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
									...
									}), data.divisions.map((d) => /* @__PURE__ */ jsx("option", {
										value: d.id,
										children: d.name
									}, d.id))]
								})] }),
						...
						/* @__PURE__ */ jsxs("form", {
							...
							children: [
								/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
									...
									}), data.districts.map((dist) => /* @__PURE__ */ jsxs("option", {
										value: dist.id,
										children: [
											dist.name,
											" (",
			...
			addProjectOpen && /* @__PURE__ */ jsx("div", {
				className: "fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm p-4 animate-in fade-in",
				children: /* @__PURE__ */ jsxs("div", {
					className: "w-full max-w-md rounded-2xl bg-card border border-border p-6 shadow-2xl relative",
					children: [
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
										...
										}), data.areas.map((a) => /* @__PURE__ */ jsxs("option", {
											value: a.id,
											children: [
												a.name,
												" (",
